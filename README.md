...
**[Download for Windows — Stable](https://github.com/benthompsondev/usageloop/releases/download/v1.1.1/UsageLoop-Setup.exe)**
· **[Download for Linux — Beta](https://github.com/benthompsondev/usageloop/releases/tag/v1.1.0-beta.1)**
· [Windows release notes](https://github.com/benthompsondev/usageloop/releases/tag/v1.1.1)
...
Download the stable v1.1.1 per-user installer:

- [UsageLoop-Setup.exe](https://github.com/benthompsondev/usageloop/releases/download/v1.1.1/UsageLoop-Setup.exe)
- [UsageLoop-Setup.exe.sha256](https://github.com/benthompsondev/usageloop/releases/download/v1.1.1/UsageLoop-Setup.exe.sha256)
